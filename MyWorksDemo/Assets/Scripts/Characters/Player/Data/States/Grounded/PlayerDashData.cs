...
namespace YuanshenMovementSystem
{
    ...
    {
        [field: SerializeField][field: Range(1f, 5f)] public float SpeedModifier { get; private set; } = 2f;
        ...
        [field: SerializeField][field: Range(0f, 5f)] public float DashLimtReachedCooldown { get; private set; } = 1.75f;
    }
}

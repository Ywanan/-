...
namespace YuanshenMovementSystem
{
    public class PlayerFallingState : PlayerAirborneState
    {
        ...
        private Vector3 plyaerPositionOnEnter;
        ...
        public override void Enter()
        {
            ...
            plyaerPositionOnEnter = stateMachine.Player.transform.position;
        ...
        {
            float fallDistance = plyaerPositionOnEnter.y - stateMachine.Player.transform.position.y;
